...
def main():
    ...
    cur.execute("SELECT id FROM bb_modeli WHERE naziv=%s AND ROUND(temperatura::numeric,4)=ROUND(%s::numeric,4)",
    ...
    for kod in args.jezici:
        ...
        for i in range(0, len(todo), BATCH_SIZE):
            ...
            print(f"  Batch {i//BATCH_SIZE + 1}: rečenice {chunk[0][1]}–{chunk[-1][1]}")
